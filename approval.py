...
"border-radius: 10px;")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("reject.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.reject_training_button.setIcon(icon2)
...
"border-radius: 10px;")
        ...
        self.approve_training_button.setIcon(icon3)
...
"border: none;")
        ...
        self.training_status_db.setGeometry(QtCore.QRect(870, 100, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)

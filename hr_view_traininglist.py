...
class HR_Training(QtWidgets.QMainWindow):
    ...
    def create_new_training(self):
        ...
        # self.brochure_button.clicked.connect()
        ...
        self.cancel_button.clicked.connect(self.back_HR_main)
    ...
    def back_HR_main(self):
        self.close()  # Close the current page widget

        if not hasattr(self, 'constructor_window'):
            self.constructor_window = HR_Training()  # Create an instance of the class
            self.constructor_window.show()  # Show the constructor window
